...
const FavoriteList = require("./favoriteListSchema");
const shareLink = require("./shareLinkSchema");
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    const deletedFavoriteList =
      await FavoriteList.findByIdAndDelete(favoriteListId);
