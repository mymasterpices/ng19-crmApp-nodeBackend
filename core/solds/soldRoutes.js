...
router.get("/get", verifyToken, async (req, res) => {
  try {
    const { full_name, sales_staff, tag } = req.query;
    let query = {};
    ...
    // Search within the products array
    if (tag) {
      // Using regex for partial matching (e.g., searching "B100" finds "B100455")
      query["products.tag"] = { $regex: tag, $options: "i" };
    }
